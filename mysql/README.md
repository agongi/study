...
|-------------|-------------------------------------------|-------------------------------------------------------------------------|-------------------------------|
| `TIMESTAMP` | 1970-01-01 00:00:00 ~ 2038-01-19 03:14:07 | 1751706493 으로 UTC 기준 정수형<br> (UTC 기준으로 저장되므로 서버의 타임존에 따라 다른 값으로 보일수 있음) | 2038 이후를 표현할 수 없으므로 지양해야 하지 않을까   |
